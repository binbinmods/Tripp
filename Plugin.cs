...
namespace Tripp
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Tripp";
        public static string heroName = characterName;

        public static string subclassName = "Trapper"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Tripp, the Trapper.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Tripp",
                _contentFolder: "Tripp",
